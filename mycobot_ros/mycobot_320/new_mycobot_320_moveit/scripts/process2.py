...
def move_to_goalpose(x, y, link6_angle):
    ...
    joint_goal = [radian(int(j1)), radian(int(j2)), radian(int(j3)), radian(int(j4)), radian(int(j5)), radian(int(j6) - int(abs(link6_angle)))]
                    ...
                    if not busy:
                        if data_input=='A':
                            if A_count == 1:
                                ...
                                move_to_pose(-109, -20, -47, -10, 89, -15) 
                                time.sleep(0.5)
                                move_to_zpose(6)
                                time.sleep(0.5)
                                move_gripper(40)
                                ...
                                move_to_pose(-14,10,2,71,-90,-16)
                                time.sleep(0.5)
                                move_to_pose(-100,-55, 11,-32,91,76) 
                                time.sleep(0.5)
                                move_to_zpose(2)
                                time.sleep(0.5)
                                move_gripper(40)
