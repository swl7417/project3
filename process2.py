...
ser2 = serial.Serial('COM14',9600,timeout=1)
print(ser)
print(ser2)
read = 0
...
class CommandInputWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.label.setGeometry(60, 300, 150, 80)  # (x, y, width, height)
        font = QFont()
        ...
        self.frame.setGeometry(20, 50, 150, 200)
        ...
        self.frame2.setGeometry(170, 50, 100, 100)
        ...
        # Create a label for the frame
        self.frame2_label = QLabel("B_BOX", self.frame2)
        font = QFont()
        ...
        self.frame3.setGeometry(170, 150, 100, 100)
        ...
        # Create a label for the frame
        self.frame3_label = QLabel("A_BOX", self.frame3)
        font = QFont()
        font.setPointSize(7)  # Set font size to 14
        ...
        button_1 = QPushButton('B_conv\nstart', self)
        button_1.setGeometry(170, 320, 100, 50)
        button_1.clicked.connect(self.send_command_1)

        button_2 = QPushButton('A_conv\nstart', self)
        button_2.setGeometry(170, 380, 100, 50)
        button_2.clicked.connect(self.send_command_2)

        button_3 = QPushButton('process\nstart', self)
        button_3.setGeometry(170, 260, 100, 50)
...
def main():
    ...
    server_address = ('172.30.1.95', 8080)
